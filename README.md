...
[![Stars](https://img.shields.io/github/stars/WeAreDevs-Execute-Update-v3.1?style=flat-square)](https://github.com)
...
git clone https://github.com/WeAreDevs-Execute-Update-v3.1.git
cd WeAreDevs-Execute-Update-v3.1
